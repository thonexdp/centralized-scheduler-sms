...
@section('content')
        ...
        <nav class="mb-4 pb-2 border-bottom" aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./index.html"><i class="ri-home-line align-bottom me-1"></i> Meeting</a></li>
            </ol>
        </nav>            <!-- / Breadcrumbs-->
        ...
        <div class="row g-4 mb-4">
          ...
          <div class="card">
            <div class="card-header justify-content-between align-items-center d-flex">
                ...
                <a href="/meeting" class="btn btn-outline-light btn-sm"><i class="ri-arrow-left-line"></i> Back</a>
            </div>
            <div class="card-body">
              @if(!empty($meeting))
            ...
            @endif
              ...
              <div class="row">
                ...
                {{-- <div class="col-md-4">
                  ...
                  <table class="table table-striped" id="employeelist-table-participants">
                    <thead>
                      <tr>
