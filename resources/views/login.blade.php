    ...
    <body class="">
        ...
        <section class="d-flex justify-content-center align-items-start vh-100 py-2 px-3 px-md-0">
          ...
          <div class="d-flex flex-column w-50 align-items-center">
            ...
            <div class="shadow-lg rounded p-4 p-sm-5 mt-10 bg-white form">
              <center>
              <h5 class="text-muted"> <b>Centralized Scheduler and Notifications System</b> </h5>
              ...
              <form class="mt-4" id="login-form">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control form-control-light" name="username" id="login-email" placeholder="Enter Username" required>
                </div>
                <div class="form-group">
            ...
            $.ajax({
               ...
               //   $('#login-form').find('select').removeClass('is-invalid');
                ...
                success:function(data){
                  console.log(data);
                    if(data.status === 400){
                      $('.alertmessage').html('<div class="alert alert-danger-faded" role="alert">'+data.message+'!</div>')
