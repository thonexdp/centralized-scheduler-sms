<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets\calendar\css\calendars\calendars\app-calendar.css')}}">
    ...
    <!-- Page Title -->
    <title>Centralized Scheduling and Notifications System</title>
